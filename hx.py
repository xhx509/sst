...
def getsst(ask_input):
    ...
    if (year<1999) or (year>2005):
      ...
      url1='http://tds.marine.rutgers.edu:8080/thredds/dodsC/cool/avhrr/bigbight/'+str(year)+'?time[0:1:3269]'
      #url1='http://tds.maracoos.org/thredds/dodsC/cool/avhrr/bigbight/'+str(year)+'?time[0:1:3269]'
...
def plot_getsst(ask_input,utc,gbox):
  ...
  CS = plt.contourf(X,Y,sst_part[0],np.arange(6,26,3.0))
  #CS = plt.contourf(X,Y,sst_part[0],(ma-mi+0.1)/7.0)
